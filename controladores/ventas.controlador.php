	...
	static public function ctrCrearVenta() {
		...
		if (isset($_POST["nuevaVenta"])) {
			...
			if ($respuesta == "ok") {
				...
				// PARA LA IMPRESORA DE TICKETS PRUEBA 
				//------------------------------------
				...
				//------------------------------------
				// PARA LA IMPRESION DEL TICKET DE LA VENTA 
				//------------------------------------
				...
				// $printer->text("Telefono: 300 786 52 49"."\n");//Teléfono de la empresa
				...
				// $traerVendedor = ModeloUsuarios::mdlMostrarUsuario($tablaVendedor, $item, $valor);
				...
				// $printe->cut();//Cortamos el papel, si la impresora tiene la opción

				// $printer->pulse();//Por medio de la impresora mandamos un pulso, es útil cuando hay cajon monedero
				...
				echo'<script>
					...
					localStorage.removeItem("seleCliente");
		...
		if (isset($_GET["idVenta"])) {
			...
			if (count($guardarFechas) > 1) {
				...
				if ($traerVenta["fecha"] > $guardarFechas[count($guardarFechas) - 2]) {
					...
					$compasCliente = ModeloClientes::mdlActualizarCliente($tablaClientes, $item, $valor, $valorIdCliente);
